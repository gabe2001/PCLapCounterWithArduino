/*****************************************************************************************
   ...
   2019-07-18 Gabriel Inäbnit      Three lanes trim down
...
const byte laneToInterrupMapping[] = { 2, 3, 20 };
...
//}
void attachAllInterrupts() {
  attachInterrupt(digitalPinToInterrupt(LANE_1), lapDetected1, FALLING);
  attachInterrupt(digitalPinToInterrupt(LANE_2), lapDetected2, FALLING);
  attachInterrupt(digitalPinToInterrupt(LANE_3), lapDetected3, FALLING);
}
